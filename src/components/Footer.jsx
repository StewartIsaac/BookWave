...
const Footer = () => {
  return (
    <footer className="flex flex-col gap-0 content-center justify-center bg-gradient-to-tl from-green-500 to-green-700 text-white text-center p-4 mt-4 md:flex-row md:gap-52">
